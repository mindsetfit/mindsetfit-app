...
echo "====================================="
echo "  CRIANDO BASE DE DADOS DE TREINOS   "
echo "  (src/data/exercises/weekly_plan.ts)"
echo "====================================="

mkdir -p src/data/exercises

cat << 'EOT' > src/data/exercises/weekly_plan.ts
...
echo "====================================="
echo "  weekly_plan.ts CRIADO COM SUCESSO ✅"
echo "  Caminho: src/data/exercises/weekly_plan.ts"
echo "====================================="
