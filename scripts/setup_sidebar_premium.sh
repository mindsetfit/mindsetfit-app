...
echo "====================================="
echo "  CRIANDO / ATUALIZANDO SIDEBAR ⭐"
echo "====================================="

mkdir -p src/components/custom

cat << 'EOT' > src/components/custom/sidebar.tsx
"use client";
...
echo "====================================="
echo "  SIDEBAR PREMIUM CRIADO / ATUALIZADO ✔"
echo "  Arquivo: src/components/custom/sidebar.tsx"
echo "====================================="
